...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description="Generate PyMOL script for BD001 mutation labeling and interaction surface calculation."
    )
...
def main():
    ...
    receptor_resids = ",".join(
        map(str, data_receptor[data_receptor["Energy (e)"] < ENERGY_THRESHOLD]["receptor_resid"])
    )
