...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        default="C:/Users/imata/Desktop/peter@gpu_server/H08--MASP2/analysis/posco_interactions.parquet",
    )
    ...
    parser.add_argument(
        ...
        "--ligand_interaction",
        required=False,
        help="Define ligand analysis output file/directory, .svg",
    ...
    parser.add_argument(
        ...
        required=False,
        help="Define receptor analysis output file/directory, .svg",
...
def interaction_data_aggregation(interaction_partner, interaction_type):
    ...
    if interaction_type == "H-bond":
        df_interaction = df_filtered[
            (df_filtered["Interaction Type"] == interaction_type) & (df_filtered["Marked as Salt-Bridge"] == 0)
        ]
...
def main():
    ...
    for fig_file, interaction_partner in zip(figure_files, ["ligand", "receptor"]):
        ...
        for i, interaction_type in enumerate(
            ["total", "H-bond", "lipophilic", "Salt bridge"]
        ):  # , 'Marked as Salt-Bridge'
