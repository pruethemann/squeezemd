...
def simulate(args, params):
    ...
    recordInterval = int(params['simulation']['recording_interval_ps'] * 1000 / params['simulation']['constraints']['dt_fs'])
...
def parse_arguments():
    ...
    parser.add_argument('--metadynamics_hills', '--metadynamics_hill', dest='metadynamics_hills', help='Metadynamics hill output file.')
